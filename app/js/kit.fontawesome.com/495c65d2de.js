  ...
  try {
    if (window.FontAwesomeKitConfig) {
      ...
      'js' === f.method &&
        ...
        'pro' === i.license &&
          ((l.autoFetchSvg = !0), (l.fetchSvgFrom = i.baseUrl + '/releases/' + ('latest' === i.version ? 'latest' : 'v'.concat(i.version)) + '/svgs')),
        ...
        'css' === f.method &&
          (function (e, t) {
            ...
            e.autoA11y.enabled &&
              (r(i), (n = i), 'undefined' != typeof MutationObserver && new MutationObserver(n).observe(document, { childList: !0, subtree: !0 })),
              e.v4shim.enabled &&
                (e.license,
